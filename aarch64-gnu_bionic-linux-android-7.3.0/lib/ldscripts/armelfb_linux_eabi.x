...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/thomas/crosstool-ng/builds/aarch64-gnu_bionic-linux-android/aarch64-gnu_bionic-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
